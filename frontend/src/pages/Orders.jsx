...
const Orders = () => {
    ...
    const fetchOrders = async () => {
      ...
      try {
        ...
        if (viewOption === "all") {
          ...
          res = await API.get(`/orders/customer/${selectedCustomer}`, {
            params: { page, limit },
          });
        } else {
          setOrders([]);
  ...
  return (
    <Box bgGradient="linear(to-b, gray.900, gray.800)" pt={4} pl={4}>
      <Breadcrumb
        spacing="8px"
      ...
      >
        ...
        >
          ...
          >
            <option style={optionStyle} value="all">See All Orders</option>
            <option style={optionStyle} value="customer">See Orders By Customer</option>
          </Select>
